...
4. **Code Optimization and Debugging:**  
   ...
   The above screenshot shows how I use serial function to check whether my serial printer is working and whether the device detect it when I press the button.
